...
const NICHE_VALUES: Record<string, { min: number; max: number; recurrence: number }> = {
  ...
  'dermatologista': { min: 2000, max: 3500, recurrence: 350 },
  'fonoaudiologia': { min: 1200, max: 2000, recurrence: 220 },
  'protese dentaria': { min: 1500, max: 2500, recurrence: 250 },
  'ortopedista': { min: 2000, max: 3500, recurrence: 350 },
  'oftalmologista': { min: 1800, max: 3000, recurrence: 300 },
  'pediatra': { min: 1500, max: 2500, recurrence: 280 },
  'ginecologista': { min: 1500, max: 2800, recurrence: 280 },
  'cardiologista': { min: 2000, max: 3500, recurrence: 350 },
  'otorrino': { min: 1500, max: 2500, recurrence: 280 },
  'urologista': { min: 1800, max: 3000, recurrence: 300 },
  'cirurgiao': { min: 3000, max: 5000, recurrence: 500 },
  'endocrinologista': { min: 1500, max: 2800, recurrence: 280 },
  'acupuntura': { min: 1000, max: 1800, recurrence: 200 },
  'quiropraxia': { min: 1000, max: 1800, recurrence: 200 },
  'podologia': { min: 800, max: 1400, recurrence: 160 },
  'coach': { min: 1200, max: 2200, recurrence: 250 },
  'consultoria': { min: 1500, max: 3000, recurrence: 300 },
  'creche': { min: 1200, max: 2000, recurrence: 220 },
  'escola infantil': { min: 1200, max: 2200, recurrence: 240 },
  'faculdade': { min: 2000, max: 4000, recurrence: 400 },
  'idiomas': { min: 1000, max: 1800, recurrence: 200 },
  'informatica': { min: 800, max: 1400, recurrence: 160 },
  'danca': { min: 800, max: 1400, recurrence: 160 },
  'luta': { min: 800, max: 1400, recurrence: 160 },
  'natacao': { min: 1000, max: 1800, recurrence: 200 },
  'despachante': { min: 800, max: 1400, recurrence: 160 },
  'seguradora': { min: 1500, max: 3000, recurrence: 300 },
  'energia solar': { min: 2000, max: 4000, recurrence: 400 },
  'dedetizadora': { min: 800, max: 1400, recurrence: 160 },
  'vidracaria': { min: 800, max: 1400, recurrence: 160 },
  'marcenaria': { min: 1000, max: 1800, recurrence: 200 },
  'serralheria': { min: 800, max: 1400, recurrence: 160 },
  'ar condicionado': { min: 800, max: 1400, recurrence: 160 },
  'informatica': { min: 800, max: 1400, recurrence: 160 },
  'assistencia tecnica': { min: 800, max: 1400, recurrence: 160 },
  'celular': { min: 700, max: 1200, recurrence: 150 },
  'relojoaria': { min: 600, max: 1100, recurrence: 140 },
  'costureira': { min: 500, max: 900, recurrence: 120 },
  'brechó': { min: 500, max: 900, recurrence: 120 },
  'sex shop': { min: 800, max: 1400, recurrence: 160 },
  'emporio': { min: 800, max: 1400, recurrence: 160 },
  'doceria': { min: 600, max: 1100, recurrence: 140 },
  'food truck': { min: 600, max: 1000, recurrence: 130 },
  'marmitaria': { min: 600, max: 1000, recurrence: 130 },
  'acougue': { min: 700, max: 1200, recurrence: 150 },
  'peixaria': { min: 700, max: 1200, recurrence: 150 },
