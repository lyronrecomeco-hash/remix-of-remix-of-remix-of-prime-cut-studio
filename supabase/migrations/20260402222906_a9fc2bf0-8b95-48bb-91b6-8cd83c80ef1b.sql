...
-- Add subscription columns to analytics
ALTER TABLE genesis_cakto_analytics 
  ADD COLUMN IF NOT EXISTS subscriptions_active INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS subscriptions_cancelled INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS subscriptions_overdue INTEGER NOT NULL DEFAULT 0;

-- Update the trigger function to handle ALL event types including subscriptions
