      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="aspect-square bg-slate-800/50 rounded-2xl overflow-hidden relative">
              {allImages.length > 0 ? (
                <img
          ...
          >
            <div>
              {product.brand && (
                <p className="text-slate-400 mb-2">{product.brand}</p>
              )}
              ...
              <div className="flex items-center gap-2 text-sm text-slate-400">
                ...
                {product.stock_quantity > 0 ? (
                  <span>Em estoque ({product.stock_quantity} disponíveis)</span>
                ) : (
              ...
              <Card className="bg-slate-900/50 border-slate-700/50">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Consulte prazo</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="bg-slate-900/50 border-slate-700/50">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Produto garantido</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-3 pt-4">
              <Button
                size="lg"
                className="w-full bg-blue-600 hover:bg-blue-500 h-14 text-lg gap-2"
            ...
            {product.specifications && typeof product.specifications === 'object' && Object.keys(product.specifications).length > 0 && (
              <div>
                <h2 className="text-lg font-semibold text-white mb-3">Especificações</h2>
