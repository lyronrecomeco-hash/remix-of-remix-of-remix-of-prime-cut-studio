    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Button onClick={generatePDFReport} className="bg-blue-600 hover:bg-blue-700 text-white">
          ...
          <Card className="bg-gradient-to-br from-blue-500 to-blue-600 border-0">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-blue-100">Total em Vendas</p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-green-200">Ticket médio: R$ {avgTicket.toFixed(2)}</p>
                </div>
                <div className="p-3 bg-white/20 rounded-xl">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <Card className="bg-gradient-to-br from-purple-500 to-purple-600 border-0">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-purple-100">Novos Clientes</p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          <Card className="bg-gradient-to-br from-orange-500 to-orange-600 border-0">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-orange-100">Parcelas Atrasadas</p>
                  <p className="text-2xl font-bold text-white">{overdueInstallments}</p>
                  <p className="text-xs text-orange-200">de {pendingInstallments} pendentes</p>
                </div>
                <div className="p-3 bg-white/20 rounded-xl">
        ...
        <Card className="bg-white border-gray-200">
          ...
          <CardContent>
            ...
            <div className="flex justify-center gap-6 mt-4">
              {installmentsChartData.map((item) => (
