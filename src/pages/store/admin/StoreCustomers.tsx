...
const creditScoreColors: Record<string, { bg: string; text: string; label: string }> = {
  excellent: { bg: 'bg-emerald-50', text: 'text-emerald-600', label: 'Excelente' },
  good: { bg: 'bg-blue-50', text: 'text-blue-600', label: 'Bom' },
  regular: { bg: 'bg-amber-50', text: 'text-amber-600', label: 'Regular' },
  bad: { bg: 'bg-red-50', text: 'text-red-600', label: 'Ruim' },
};
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">Gerencie seus clientes e crédito</p>
        </div>
        <Button
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{formatCPF(customer.cpf)}</p>
                      </div>
                    </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="bg-white border-gray-100 text-gray-900 max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="text-gray-700">Score de Crédito</Label>
                <Select
              ...
              <div className="space-y-2">
                <Label className="text-gray-700">Limite de Crédito</Label>
                <Input
                  type="number"
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Label className="text-gray-700">Cliente ativo</Label>
            </div>
