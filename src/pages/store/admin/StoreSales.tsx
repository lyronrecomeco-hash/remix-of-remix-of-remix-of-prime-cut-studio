...
const statusConfig: Record<string, { label: string; color: string; icon: any }> = {
  ...
  approved: { label: 'Aprovada', color: 'bg-blue-500/10 text-blue-400 border-blue-500/20', icon: Check },
  delivered: { label: 'Entregue', color: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20', icon: Truck },
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400">Gerencie suas vendas e crediário</p>
        </div>
        <Button
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <h3 className="font-semibold text-white">{sale.sale_number}</h3>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="p-4 bg-slate-800/50 rounded-xl">
              ...
              <div className="flex justify-between text-lg font-bold text-white pt-2 border-t border-slate-700">
                <span>Total:</span>
                <span className="text-blue-400">{formatCurrency(calculateTotal().total)}</span>
              </div>
            </div>
            ...
            <div className="space-y-4 mt-4">
              <div className="p-4 bg-slate-800/50 rounded-xl space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium">{selectedSale.sale_number}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Cliente:</span>
                  <span className="text-white">{selectedSale.customer?.name || 'N/A'}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-blue-400 font-bold">{formatCurrency(selectedSale.total)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Entrada:</span>
                  <span className="text-white">{formatCurrency(selectedSale.down_payment)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Parcelas:</span>
                  <span className="text-white">{selectedSale.installments_count}x</span>
                </div>
              </div>
