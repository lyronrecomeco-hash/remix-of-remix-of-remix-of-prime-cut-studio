...
const GenesisCommercialHero = () => {
  ...
  const fullText = texts.hero.highlight;
  ...
  const trustPoints = texts.hero.trustPoints.split(',').map(t => t.trim()).filter(Boolean);
      ...
      <div className="container relative z-10 px-4 pt-24 md:pt-32 pb-12 md:pb-16 max-w-7xl mx-auto flex-1 flex flex-col">
        ...
        >
          ...
          >
            ...
            <span className="text-muted-foreground">{texts.hero.badge}</span>
          </motion.div>
