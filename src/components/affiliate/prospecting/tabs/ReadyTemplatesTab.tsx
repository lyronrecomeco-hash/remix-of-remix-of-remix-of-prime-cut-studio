  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="space-y-1"
      >
        <h2 className="text-xl font-bold text-foreground">Escolha seu Ponto de Partida</h2>
        <p className="text-sm text-muted-foreground">
          Selecione um modelo como ponto de partida. Você poderá editar tudo depois.
        </p>
      </motion.div>
