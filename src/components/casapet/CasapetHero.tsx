...
interface CasapetHeroProps {
  onScheduleClick: () => void;
}

const CasapetHero = ({ onScheduleClick }: CasapetHeroProps) => {
  const features = [
    { icon: Heart, text: 'Cuidado completo', color: 'from-emerald-500 to-teal-500' },
    { icon: Star, text: 'Produtos premium', color: 'from-teal-500 to-green-500' },
    { icon: Shield, text: 'Equipe qualificada', color: 'from-green-500 to-emerald-600' },
  ];
        ...
        <div className="max-w-2xl mx-auto sm:mx-0 text-center sm:text-left">
          ...
          >
            ...
            >
              ...
              Veterinário • Pet Shop • Agendamento Online
            </motion.span>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] mb-4 sm:mb-6">
              ...
              <span className="relative inline-block">
                ...
                >
                  ...
                  />
                  <defs>
                    <linearGradient id="gradientCasapet" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <p className="text-sm sm:text-lg md:text-xl text-white/80 mb-6 sm:mb-8 leading-relaxed max-w-lg mx-auto sm:mx-0">
              Veterinário, rações, produtos e muito <span className="text-emerald-400 font-semibold">carinho</span>. 
              Cuidamos do seu melhor amigo com amor!
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-10">
              <Button
                ...
                size="lg"
                className="bg-gradient-to-r from-emerald-500 via-teal-500 to-green-500 hover:from-green-500 hover:via-teal-500 hover:to-emerald-500 text-white font-bold text-base sm:text-lg px-6 sm:px-8 h-14 sm:h-16 rounded-2xl shadow-2xl shadow-emerald-500/40 group transition-all duration-500 hover:scale-105"
              >
