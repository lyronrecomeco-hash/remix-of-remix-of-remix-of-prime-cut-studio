...
interface CasapetContactProps {
  onScheduleClick: () => void;
}

const CasapetContact = ({ onScheduleClick }: CasapetContactProps) => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      title: 'Endereço',
      value: 'Av. Padre José Anchieta, 1030',
      subtitle: 'Guarapari - ES',
      href: 'https://www.google.com/maps/dir/?api=1&destination=Av.+Padre+José+Anchieta,+1030+-+Guarapari+-+ES',
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button
                ...
                size="lg"
                className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-teal-500 hover:to-emerald-500 text-white font-bold h-12 sm:h-14 text-sm sm:text-base rounded-xl sm:rounded-2xl shadow-xl shadow-emerald-500/30 hover:shadow-2xl transition-all"
              >
          ...
          >
            <div className="bg-white rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3739.5!2d-40.5!3d-20.67!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xb816e!2sAv.+Padre+Jos%C3%A9+Anchieta%2C+1030+-+Guarapari%2C+ES!5e0!3m2!1spt-BR!2sbr!4v1705000000000!5m2!1spt-BR!2sbr"
                width="100%"
                height="250"
                ...
                title="Localização Casa Pet Gri"
              />
              <div className="p-4 sm:p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-base sm:text-lg">Casa Pet Gri</h3>
                    <p className="text-gray-500 text-xs sm:text-sm">Av. Padre José Anchieta, 1030 - Guarapari, ES</p>
                  </div>
                </div>
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Av.+Padre+José+Anchieta,+1030+-+Guarapari+-+ES"
