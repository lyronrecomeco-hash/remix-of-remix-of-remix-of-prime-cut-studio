...
import { getCasapetAppointments } from '@/components/casapet/CasapetMyAppointments';

interface CasapetHeaderProps {
  onScheduleClick: () => void;
  onMyAppointmentsClick?: () => void;
}

const CasapetHeader = ({ onScheduleClick, onMyAppointmentsClick }: CasapetHeaderProps) => {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="bg-gradient-to-r from-emerald-600 via-teal-500 to-emerald-600 text-white py-2 text-xs sm:text-sm">
        <div className="container mx-auto px-3 sm:px-4">
          <div className="flex justify-between items-center">
            <a href="https://wa.me/5528999999999" className="flex items-center gap-1.5 sm:gap-2 hover:underline font-medium">
              <Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              <span className="hidden xs:inline">(28) 99999-9999</span>
        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <a href="#inicio" className="flex items-center gap-2 sm:gap-3 group">
              <motion.div 
                className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/30 group-hover:scale-105 transition-transform"
            ...
            <div className="hidden md:flex items-center gap-2 lg:gap-3">
              ...
              <Button
                ...
                size="sm"
                className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-teal-500 hover:to-emerald-500 text-white font-bold rounded-xl shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all duration-300 hover:scale-105"
              >
              ...
              <nav className="container mx-auto px-4 py-4 flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Button
                    ...
                    className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold w-full h-14 text-base rounded-xl shadow-lg shadow-emerald-500/30"
                  >
