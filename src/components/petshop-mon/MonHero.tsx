...
const MonHero = ({ onScheduleClick }: MonHeroProps) => {
  const features = [
    { icon: Heart, text: 'Mais cheiroso', color: 'from-cyan-500 to-blue-500' },
    { icon: Star, text: 'Profissionais top', color: 'from-blue-500 to-indigo-500' },
    { icon: Shield, text: 'Ambiente climatizado', color: 'from-indigo-500 to-cyan-600' },
  ];
        ...
        <div className="max-w-2xl mx-auto sm:mx-0 text-center sm:text-left">
          ...
          >
            ...
            >
              ...
              Banho e Tosa • Ambiente Climatizado • Espaço Pet
            </motion.span>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] mb-4 sm:mb-6">
              ...
              <span className="relative inline-block">
                ...
                >
                  ...
                  />
                  <defs>
                    <linearGradient id="gradientMon" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <p className="text-sm sm:text-lg md:text-xl text-white/80 mb-6 sm:mb-8 leading-relaxed max-w-lg mx-auto sm:mx-0">
              Ambiente climatizado, espaço pet e muito <span className="text-cyan-400 font-semibold">carinho</span>. 
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-10">
              <Button
                ...
                size="lg"
                className="bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 hover:from-indigo-500 hover:via-blue-500 hover:to-cyan-500 text-white font-bold text-base sm:text-lg px-6 sm:px-8 h-14 sm:h-16 rounded-2xl shadow-2xl shadow-cyan-500/40 group transition-all duration-500 hover:scale-105"
              >
