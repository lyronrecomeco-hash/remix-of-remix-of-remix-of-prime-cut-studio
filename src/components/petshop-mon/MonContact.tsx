...
interface MonContactProps {
  onScheduleClick: () => void;
}

const MonContact = ({ onScheduleClick }: MonContactProps) => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Instagram,
      title: 'Instagram',
      value: '@banhoetosa.monpetit',
      subtitle: 'Siga-nos',
      href: 'https://www.instagram.com/banhoetosa.monpetit.aracruz/',
      color: 'from-pink-500 to-purple-500',
    },
    {
      icon: MapPin,
      title: 'Endereço',
      value: 'Cohab 2 - Aracruz',
      subtitle: 'Aracruz - ES',
      href: 'https://www.google.com/maps/dir/?api=1&destination=Cohab+2+-+Aracruz+-+ES',
    ...
    <section id="contato" className="py-12 sm:py-20 bg-gray-900 relative overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <motion.span 
              className="inline-flex items-center gap-2 bg-cyan-500/20 text-cyan-400 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold mb-3 sm:mb-4"
                ...
                >
                  {info.href ? (
                    <a 
                      ...
                      className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 bg-white/5 hover:bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 transition-all border border-white/10 hover:border-cyan-500/30 group"
                    >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button
                ...
                size="lg"
                className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-blue-500 hover:to-cyan-500 text-white font-bold h-12 sm:h-14 text-sm sm:text-base rounded-xl sm:rounded-2xl shadow-xl shadow-cyan-500/30 hover:shadow-2xl transition-all"
              >
          ...
          >
            <div className="bg-white rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29864.0!2d-40.27!3d-19.82!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xb6bd0e64d4bfcb%3A0x8a7a1a8b0c3d4e5f!2sAracruz%2C%20ES!5e0!3m2!1spt-BR!2sbr!4v1705000000000!5m2!1spt-BR!2sbr"
                width="100%"
                height="250"
                ...
                title="Localização Mon Petit Aracruz"
              />
              <div className="p-4 sm:p-6">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl flex items-center justify-center">
                    <span className="text-xl sm:text-2xl">🐾</span>
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 text-base sm:text-lg">Mon Petit Aracruz</h3>
                    <p className="text-gray-500 text-xs sm:text-sm">Cohab 2 - Aracruz, ES</p>
                  </div>
                </div>
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Cohab+2+-+Aracruz+-+ES"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-cyan-600 font-semibold text-sm hover:underline group"
                >
