...
const MonGallery = () => {
  ...
  const images = [
    { src: gallery1, alt: 'Pet estiloso', caption: 'Fofura do dia' },
    { src: gallery2, alt: 'Pet natalino', caption: 'Rena fofa' },
    { src: gallery3, alt: 'Pet de Natal', caption: 'Mamãe Noel' },
    { src: gallery4, alt: 'Spitz no cenário', caption: 'Tema Chaves' },
    { src: gallery5, alt: 'Cachorro natalino', caption: 'Rena de Natal' },
    { src: gallery6, alt: 'Shih Tzu', caption: 'Vila do Chaves' },
    { src: gallery7, alt: 'Pet com chapéu', caption: 'Chapéu Chaves' },
  ];
  ...
  return (
    <>
      <section ref={ref} id="galeria" className="py-12 sm:py-20 px-4 bg-gradient-to-b from-white to-cyan-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <span className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 text-cyan-600 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold mb-3 sm:mb-4 border border-cyan-500/20">
              <Camera className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              Galeria
            </span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-800 mb-3 sm:mb-4">
              Nossos <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">xodós</span>
            </h2>
          ...
          >
            {[
              ...
              <div key={i} className="text-center">
                <p className="text-xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">{stat.value}</p>
