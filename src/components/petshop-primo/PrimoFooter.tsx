...
const PrimoFooter = () => {
  const services = [
    ...
    { name: 'Farmácia Pet', href: '#servicos' },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-10 mb-8 sm:mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 sm:gap-3 mb-4">
              <motion.div 
                className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-emerald-500 to-green-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/30"
                whileHover={{ scale: 1.05, rotate: 5 }}
              >
                <span className="text-xl sm:text-2xl">🐾</span>
              </motion.div>
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-white">PrimoPet</h3>
                <p className="text-[10px] sm:text-xs text-emerald-400 font-semibold">RECIFE</p>
              </div>
            </div>
            <p className="text-white/60 text-xs sm:text-sm mb-4 sm:mb-6 leading-relaxed max-w-xs">
              Pet Shop, Centro Estético e Farmácia Veterinária. Somos todos primos! 🐕❤️
            </p>
            <a
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                ...
                >
                  ...
                  <span className="truncate">@primopetrecife</span>
                </a>
              </li>
              <li>
                <span className="flex items-start gap-2 text-white/60 text-xs sm:text-sm">
                  <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 flex-shrink-0" />
                  <span>Av. Visconde de Albuquerque, 894<br />Recife - PE, 50610-090</span>
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/10">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            <p className="text-[10px] sm:text-sm text-white/40 text-center sm:text-left">
              © {new Date().getFullYear()} PrimoPet Recife. Todos os direitos reservados.
            </p>
