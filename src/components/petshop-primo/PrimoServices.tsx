...
interface PrimoServicesProps {
  onScheduleClick: () => void;
}

const PrimoServices = ({ onScheduleClick }: PrimoServicesProps) => {
  ...
  const services = [
    ...
    },
    {
      ...
      highlightColor: 'from-lime-500 to-green-500',
    ...
    },
    {
      ...
      description: 'Rações, medicamentos, petiscos, acessórios e tudo que seu pet precisa das melhores marcas.',
      image: serviceShop,
      price: 'Diversos',
      priceLabel: 'produtos',
      duration: null,
      ...
      features: ['Rações premium', 'Medicamentos', 'Acessórios', 'Delivery'],
    },
  ];
  ...
  return (
    <section id="servicos" className="py-16 sm:py-24 bg-gradient-to-b from-white via-emerald-50/30 to-white" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        >
          <motion.span 
            className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500/10 to-green-500/10 text-emerald-600 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold mb-4 sm:mb-6 border border-emerald-500/20"
            initial={{ scale: 0.9 }}
            ...
            >
              ...
              <div className="p-4 sm:p-6 md:p-8">
                ...
                <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                  <div className="w-11 h-11 sm:w-14 sm:h-14 bg-gradient-to-br from-emerald-500 to-green-500 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/30 flex-shrink-0">
                ...
                <Button
                  ...
                  className="w-full h-11 sm:h-14 text-sm sm:text-lg font-bold bg-gradient-to-r from-emerald-500 to-green-500 hover:from-green-500 hover:to-emerald-500 text-white rounded-xl sm:rounded-2xl shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all duration-300 group/btn"
                >
        ...
        >
          <div className="bg-gradient-to-r from-emerald-500/10 to-green-500/10 rounded-2xl p-4 text-center border border-emerald-500/20">
