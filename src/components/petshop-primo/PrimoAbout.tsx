...
const PrimoAbout = () => {
  ...
  const stats = [
    { icon: Users, value: '5.000+', label: 'Pets Atendidos', color: 'from-emerald-500 to-green-500' },
    { icon: Award, value: '10+', label: 'Anos', color: 'from-green-500 to-lime-500' },
    { icon: Heart, value: '100%', label: 'Amor', color: 'from-lime-500 to-emerald-500' },
  ];
    ...
    <section id="sobre" className="py-12 sm:py-20 bg-gradient-to-b from-white to-emerald-50/50" ref={ref}>
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-xs sm:text-sm">PrimoPet</p>
                    <p className="text-gray-500 text-[10px] sm:text-xs">Recife - PE</p>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          >
            <motion.span 
              className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500/10 to-green-500/10 text-emerald-600 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold mb-3 sm:mb-4 border border-emerald-500/20"
            ...
            <p className="text-gray-600 text-sm sm:text-lg mb-6 sm:mb-8 leading-relaxed">
              Pet Shop, Centro Estético e Farmácia Veterinária. Cuidando do seu melhor amigo com amor, carinho e profissionalismo! 🐾
            </p>
            ...
            {/* CTA Card */}
            <motion.div 
              className="bg-gradient-to-r from-emerald-500/10 to-green-500/10 rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-emerald-500/20"
              initial={{ opacity: 0, scale: 0.95 }}
              animate={isInView ? { opacity: 1, scale: 1 } : {}}
              transition={{ delay: 0.6 }}
            >
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-emerald-500 to-green-500 rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-500/30">
