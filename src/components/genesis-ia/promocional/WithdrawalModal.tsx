/**
 * Modal de Saque para Usuários Promocionais
 */
...
export function WithdrawalModal({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="bg-[hsl(215_30%_12%)] border-white/10 max-w-md">
        {showSuccessView ? (
          <>
            <DialogHeader>
          ...
          <>
            ...
            <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
              <p className="text-xs text-white/50 mb-1">Saldo disponível para saque</p>
