...
interface GenesisPhoneVerificationProps {
  phone: string;
  email?: string;
  name?: string;
  passwordHash?: string;
  onVerified: (data: { phone: string; email?: string; name?: string; passwordHash?: string }) => void;
  onBack: () => void;
  onResend?: () => void;
}

export function GenesisPhoneVerification({
  phone,
  email,
  name,
  passwordHash,
...
export default GenesisPhoneVerification;
