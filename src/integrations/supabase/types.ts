  ...
  public: {
    Tables: {
      ...
      gym_class_bookings: {
        ...
        Relationships: [
          {
            foreignKeyName: "gym_class_bookings_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
      ...
      gym_exercise_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "gym_exercise_logs_exercise_id_fkey"
            columns: ["exercise_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "gym_exercise_logs_workout_log_id_fkey"
            columns: ["workout_log_id"]
            isOneToOne: false
            referencedRelation: "gym_workout_logs"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      gym_exercises: {
        ...
        Relationships: [
          {
            foreignKeyName: "gym_exercises_muscle_group_id_fkey"
      ...
      gym_personal_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "gym_personal_records_exercise_id_fkey"
            columns: ["exercise_id"]
            isOneToOne: false
            referencedRelation: "gym_exercises"
            referencedColumns: ["id"]
      ...
      gym_subscriptions: {
        Row: {
          ...
          plan_id: string | null
          starts_at: string | null
          status: Database["public"]["Enums"]["gym_subscription_status"] | null
          updated_at: string
          user_id: string
        }
        Insert: {
      ...
      gym_user_workout_exercises: {
        ...
        Relationships: [
          {
            foreignKeyName: "gym_user_workout_exercises_exercise_id_fkey"
            columns: ["exercise_id"]
            isOneToOne: false
            referencedRelation: "gym_exercises"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "gym_user_workout_exercises_user_workout_id_fkey"
      ...
      gym_user_workouts: {
        ...
        Relationships: [
          {
            foreignKeyName: "gym_user_workouts_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "gym_workout_templates"
            referencedColumns: ["id"]
          },
        ]
      }
      gym_workout_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "gym_workout_logs_user_workout_id_fkey"
            columns: ["user_workout_id"]
            isOneToOne: false
            referencedRelation: "gym_user_workouts"
            referencedColumns: ["id"]
      ...
      gym_workout_template_exercises: {
        ...
        Relationships: [
          {
            foreignKeyName: "gym_workout_template_exercises_exercise_id_fkey"
            columns: ["exercise_id"]
            isOneToOne: false
            referencedRelation: "gym_exercises"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "gym_workout_template_exercises_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "gym_workout_templates"
            referencedColumns: ["id"]
      ...
      petshop_order_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "petshop_order_items_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "petshop_orders"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "petshop_order_items_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "petshop_products"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      petshop_products: {
        ...
        Relationships: [
          {
            foreignKeyName: "petshop_products_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "petshop_categories"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      store_customers: {
        Row: {
          ...
          credit_score: Database["public"]["Enums"]["store_credit_score"] | null
          email: string | null
          id: string
          is_active: boolean | null
          name: string
        ...
        Insert: {
          ...
          credit_limit?: number | null
          credit_score?:
            | Database["public"]["Enums"]["store_credit_score"]
            | null
          email?: string | null
          id?: string
          is_active?: boolean | null
      ...
      store_installments: {
        Row: {
          ...
          sale_id: string
          status: Database["public"]["Enums"]["store_installment_status"] | null
          updated_at: string | null
        }
        Insert: {
          amount: number
          ...
          sale_id: string
          status?:
            | Database["public"]["Enums"]["store_installment_status"]
            | null
          updated_at?: string | null
        }
        Update: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_installments_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "store_installments_sale_id_fkey"
            columns: ["sale_id"]
            isOneToOne: false
      ...
      store_leads: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_leads_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
      ...
      store_sales: {
        Row: {
          ...
          payment_method: string | null
          sale_number: string
          status: Database["public"]["Enums"]["store_sale_status"] | null
          subtotal: number
          total: number
          updated_at: string | null
          user_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "store_sales_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "store_customers"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      has_gym_role: {
        Args: {
          _role: Database["public"]["Enums"]["gym_role"]
          _user_id: string
        }
        Returns: boolean
      }
    ...
    Enums: {
      ...
      gym_role: "aluno" | "instrutor" | "admin"
      gym_subscription_status: "active" | "inactive" | "pending" | "cancelled"
      ...
      store_credit_score: "excellent" | "good" | "regular" | "bad"
      store_installment_status: "pending" | "paid" | "overdue" | "cancelled"
      store_sale_status: "pending" | "approved" | "delivered" | "cancelled"
